...
export default function TrackPage() {
  ...
  useEffect(() => {
    fetch("/api/brand")
      ...
      .then((d) => {
        if (d?.whatsapp_number) setBrand({ name: d.name || "MENARA", whatsapp_number: d.whatsapp_number });
      })
      .catch(() => {});
  }, []);
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (data.token) {
        sessionStorage.setItem(`menara_token_${id}`, data.token);
      }
      sessionStorage.setItem(`menara_verified_${id}`, JSON.stringify(data));
            ...
            <div className="max-w-xl mx-auto flex flex-col gap-8 pt-6 sm:pt-10 lg:pt-14">
              ...
              <section>
                ...
                <h1 className="trk-display text-[40px] leading-[1.02] sm:text-[58px] mt-5">
                  Lacak Pesanan
                  <br />
                  Kamu<span className="text-[#FFE500]">.</span>
                </h1>
                ...
                >
                  ...
                  <p className="text-[13px] text-[#6b7280] text-center mt-5">
                    ...
                    <a
                      ...
                      className="text-[#FFE500] underline underline-offset-4"
                    >
                      Tanya admin
                    </a>
                  </p>
              ...
              <section>
                <div className="grid grid-cols-3 gap-3">
                  <div className="trk-card p-4 sm:p-5 text-center">
                    <p className="trk-display text-[20px] sm:text-[24px] text-[#FFE500]">
                      450K+
                    </p>
            ...
            <div className="max-w-6xl mx-auto px-5 sm:px-8 py-7 flex flex-col sm:flex-row gap-4 sm:items-center justify-between">
              <div className="flex flex-col">
                <p className="text-[13px] text-[#9aa0aa]">
                  © 2026 MENARA — Custom Jersey &amp; Sportswear
                </p>
